 ...
 *
 * Plain (non-"use server") module so it can be shared by the Routes server
 * component and the approve/revoke Server Actions without leaking the verbose
 * internal error string (URL + status) into the UI.
 */
