 ...
 *
 * Plain (non-"use server") module so it can be shared by the Settings server
 * components and their Server Actions without leaking the verbose internal
 * error string (URL + status) into the UI.
 */
