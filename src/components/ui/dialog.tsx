  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-card border border-line-strong bg-surface shadow-2xl shadow-graphite-950/40 focus:outline-none",
          className,
        )}
        {...props}
      >
